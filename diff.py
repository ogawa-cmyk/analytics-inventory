...
def save_snapshot(inventory: dict) -> Path:
    ...
    slim = {
        ...
        "properties": [
            {
                ...
                "stream_count": p.get("stream_count"),
            }
        ...
        "sc_sites": [
            {
                "site_hash": s.get("site_hash"),
                "site_url": s.get("site_url"),
                "clicks_28d": s.get("clicks_28d"),
                "impressions_28d": s.get("impressions_28d"),
                "sitemap_count": s.get("sitemap_count"),
                "sitemap_errors": s.get("sitemap_errors"),
            }
            for s in inventory.get("sc_sites", []) or []
        ],
    }
